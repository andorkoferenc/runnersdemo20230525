...
public class RunnerController {
    ...
    public String getAllRunners(Model model) {
        ...
        model.addAttribute("averageHeight", runnerService.getRunnersAverageHeight());
        model.addAttribute("heightestRunnerName", runnerService.getHeigthestRunnerName());
        return "runners";
    }
    ...
    public String getRunnerById(@PathVariable Long id, Model model) {
        ...
        if (runner != null) {
            ...
            model.addAttribute("sponsorName", (runner.getSponsor()).getSponsorName());
            return "runner";
        } else {
            return "error";
        }
